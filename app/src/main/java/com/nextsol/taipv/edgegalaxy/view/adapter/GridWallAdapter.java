...
public class GridWallAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    List<ImageGrid>list;
    Context context;
    int layout;
    public GridWallAdapter(List<ImageGrid> list, Context context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ItemHolder(inflater.inflate(R.layout.item_image,parent,false));
    }
